...
<body>
    ...
    <div class="buycart w1200">
        @if($shop)
        <div id="cart_main">
            <div class="bc_option clearfix"></div>
        ...
        <div class="bc_prolist" id="bc_prolist">
            <h3>
            <span>买了又买</span>
            ...
            <div class="lunbo-box">
                <ul id="lunbo-img">
                    ...
                    <li>
                        ...
                        <a href="javascript:;" event-name="PC端_加入购物车_联想小新闪存盘 F300-U3 16G" latag="latag_pc_cart_buy_rec_2_52770|48635_51330_DZ03010002_a81d06dc-34f6-4226-a32a-01378e2dc136_addcart">加入购物车</a>
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <p>商城价：599元</p>
                        <div class="bc_btn" gcode="58635"><a href="javascript:;" event-name="PC端_加入购物车_新秀丽休闲款双肩包 B800" latag="latag_pc_cart_buy_rec_3_52770|48635_58635_DZ03010002_a81d06dc-34f6-4226-a32a-01378e2dc136_addcart">加入购物车</a>
                        </div>
                    </li>
