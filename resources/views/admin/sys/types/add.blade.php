...
<div class="col-md-10">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<a href="" class="btn btn-danger"><span class="glyphicon glyphicon-trash">分类广告页面</span></a>
			<a href="" class="btn btn-success"><span class="glyphicon glyphicon-plus">添加分类广告</span></a>
		</div>
		<div class="panel-body">
			<form action="/a/sys/types" method="post">
				{{csrf_field()}}
