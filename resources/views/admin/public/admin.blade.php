...
<head>
	...
	<link rel="stylesheet" href="/style/admin/public/bs/css/bootstrap.min.css">
		...
		<nav class="navbar navbar-default navbar-fixed-top navbar-color" role="navigation">
			...
			<!-- 导航logo -->
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#"><img style="display:inline" width="30px" src="/style/admin/public/img/1.png" alt="">   联想后台管理系统</a>
				</div>

			<!-- 出logo以外 -->
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						<li><a href="/a/flush"><span class="glyphicon glyphicon-refresh"></span>清除缓存</a></li>
						<li class="dropdown">
		...
		<div class="row body">
			...
			<div class="col-md-2">
				...
				<div class="panel panel-primary">
					...
					<ul class="list-group">
					    <li class="list-group-item"><a href="/a/admin">管理员列表</a></li>
